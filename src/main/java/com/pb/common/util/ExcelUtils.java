...
import com.pb.common.annotation.ExportConfig;
...
public class ExcelUtils {
    ...
    private void requiredbuilderParams() {
        if (mClass == null) {
            throw new IllegalArgumentException("请先使用com.pb.common.utils.poi.ExcelUtils.builder(Class<?>)构造器初始化参数。");
        }
    }
    ...
    private void requiredexportParams() {
        if (mClass == null || mResponse == null) {
            throw new IllegalArgumentException(
                    "请先使用com.pb.common.utils.poi.ExcelUtils.export(Class<?>, HttpServletResponse)构造器初始化参数。");
        }
