package com.pb.common.domain;

public class MymConstant {
    ...
    // 用户注册 URL
    public static final String MYM_REGIST_URL = "/user/regist";
    // 权限不足 URL
    public static final String MYM_ACCESS_DENY_URL = "/access/deny/403";
    // 社交账号绑定成功 URL
