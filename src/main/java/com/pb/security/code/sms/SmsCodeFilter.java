...
import com.pb.security.code.ValidateCode;
import com.pb.security.exception.ValidateCodeException;
...
public class SmsCodeFilter extends OncePerRequestFilter implements InitializingBean {
    ...
    private void validateSmsCode(ServletWebRequest servletWebRequest) throws ServletRequestBindingException {
        ...
        ValidateCode codeInSession = (ValidateCode) sessionStrategy.getAttribute(servletWebRequest, MymConstant.SESSION_KEY_SMS_CODE + mobile);
        ...
        if (codeInSession.isExpire()) {
            sessionStrategy.removeAttribute(servletWebRequest, MymConstant.SESSION_KEY_SMS_CODE + mobile);
