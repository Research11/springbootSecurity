package com.pb.security.code.img;
...
public class ImageCodeFilter extends OncePerRequestFilter implements InitializingBean {
    ...
    private void validateCode(ServletWebRequest servletWebRequest) throws ServletRequestBindingException {
        ImageCode codeInSession = (ImageCode) sessionStrategy.getAttribute(servletWebRequest, MymConstant.SESSION_KEY_IMAGE_CODE);
        ...
        if (codeInSession.isExpire()) {
            sessionStrategy.removeAttribute(servletWebRequest, MymConstant.SESSION_KEY_IMAGE_CODE);
