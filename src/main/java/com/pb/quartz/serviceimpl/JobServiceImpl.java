package com.pb.quartz.serviceimpl;
...
import com.pb.quartz.dao.JobMapper;
import com.pb.quartz.domain.Job;
import com.pb.quartz.service.JobService;
import com.pb.quartz.util.ScheduleUtils;
...
public class JobServiceImpl extends BaseService<Job> implements JobService {
    ...
    public List<Job> getSysCronClazz(Job job) {
        Reflections reflections = new Reflections("com.pb.quartz.task");
