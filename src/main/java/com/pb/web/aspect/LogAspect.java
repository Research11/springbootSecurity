package com.pb.web.aspect;


import com.fasterxml.jackson.databind.JsonNode;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.pb.Config.propertes.MyProperies;
import com.pb.common.annotation.Log;
import com.pb.common.util.AddressUtils;
import com.pb.common.util.HttpContextUtils;
import com.pb.common.util.IPUtils;
import com.pb.system.domain.SysLog;
import com.pb.system.service.LogService;
...
public class LogAspect {
    ...
    @Autowired
    private MyProperies myProperies;
    ...
    @Pointcut("@annotation(com.pb.common.annotation.Log)")
